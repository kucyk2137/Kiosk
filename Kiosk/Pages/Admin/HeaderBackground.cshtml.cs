...
namespace Kiosk.Pages.Admin
{
    public class HeaderBackground : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                ModelState.AddModelError(nameof(HeaderImage), "Proszę wybrać plik graficzny.");
                return Page();
            }
            ...
            TempData["StatusMessage"] = "Zdjęcie nagłówka zostało zaktualizowane.";
        ...
        public async Task<IActionResult> OnPostRemoveAsync()
        {
            ...
            TempData["StatusMessage"] = "Zdjęcie nagłówka zostało usunięte.";
            return RedirectToPage();
        }
    }
}